...
let output_filename = "output-tinyurl.xlsx";
  ...
  if(req.files){
    ...
    file.mv("./upload/"+filename1,function(err){
      if(err){
        ...
        res.send("<center><b><font size=5 color=#575353>Your file is uploaded & processing</br>This may take a time....</br>After processing the output file will be downloaded automatically</font></b></center>");
